...
var displayTable = function (currNodeSite) {
    ...
    //  $("#memoryTable p, #memoryTable table").remove();
     if (streamingRe.resultCode === "1") {
        ...
        //  fillTable(tables[1].value, res[0].value[1] + ": " + currNodeSiteArr[2]);

        // $("#title").append("<p>" + res[0].value[1] + ": " + currNodeSiteArr[2] + "</p>");
        
        $("#dataTable").append(`<div class="table-div" id="${currNodeSiteArr[2]}"></div>`)
        var valueList = tables[1].value // pubtables
        ...
        $(`#${currNodeSiteArr[2]}`).jsGrid({
            ...
            fields: [
                {
                    name: "tableName", type: "text", width: 50, align: "center",
                ...
                {
                    name: "subscriber", type: "text", width: 50, align: "center",
                    itemTemplate: function (value, item) {
                        // console.log(item);
                ...
                {
                    name: "msgOffset", type: "text", width: 50, align: "center",
                    itemTemplate: function (value, item) {
                        // console.log(item);
                ...
                {
                    name: "actions", type: "text", width: 500, align: "center",
                    itemTemplate: function (value, item) {
                        // console.log(item);
